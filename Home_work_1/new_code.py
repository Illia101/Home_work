...
#             name, extension_1 = os.path.splitext(file_name)
#             # normalize_name = normalize(name)
#             new_filename = name + extension_1
#             new_file_path = os.path.join(folder_path, new_filename)
#             shutil.move(new_file_path, r'D:\Home_work_1\images')
...
#             folder_path = os.path.dirname(document)
#             file_name = os.path.basename(document)
#             name, extension_1 = os.path.splitext(file_name)
#             # normalize_name = normalize(name)
#             new_filename = name + extension_1
#             new_file_path = os.path.join(folder_path, new_filename)
#             shutil.move(new_file_path, r'D:\Home_work_1\documents')
#         else:
#             print("File does not exist: ", document)
#     for video in VIDEO:
...
#             new_filename = name + extension_1
#             new_file_path = os.path.join(folder_path, new_filename)
#             shutil.move(new_file_path, r'D:\Home_work_1\video')
#         else:
...
#             new_filename = name + extension_1
#             new_file_path = os.path.join(folder_path, new_filename)
#             shutil.move(new_file_path, r'D:\Home_work_1\audio')
#         else:
#             print("File does not exist: ", audio)
    
#     for archives in ARCHIVES:
#         if os.path.exists(video):
#             folder_path = os.path.dirname(archives)
#             file_name = os.path.basename(archives)
#             name, extension_1 = os.path.splitext(file_name)
#             # normalize_name = normalize(name)
#             new_filename = name + extension_1
#             new_file_path = os.path.join(folder_path, new_filename)
#             shutil.move(new_file_path, r'D:\Home_work_1\archives')
#         else:
#             print("File does not exist: ", archives)
